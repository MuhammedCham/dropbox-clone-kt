      ...
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        ...
        <div className="bg-[#1E1919] dark:bg-slate-800 h-full p-10">
          <video autoPlay loop muted className="rounded-lg">
              <source
                 src="https://aem.dropbox.com/cms/content/dam/dropbox/warp/en-us/overview/lp-header-graphite200-1920x1080.mp4" type="video/mp4" />
                Oops Your browser does not support the video element.
          </video>
        </div>
      </div>
      
      <p className="text-center font-bold text-xl pt-5">Disclaimer</p>
      <p className="text-center font-light p-2">This video is purposely for information and education only. We are in no way affiliates with dropbox or/and any of its subsidiaries in any form. Copyright Disclaimer under section 107 of the copyright Act 1976, allowance is made for fair &quote use of this website for educative purposes only.</p>
    </main>
  )
}
